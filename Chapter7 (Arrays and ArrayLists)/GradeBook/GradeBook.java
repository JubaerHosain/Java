...
public class GradeBook {
	private String courseName; // name of course this GradeBook
	...
	public int getMaximum() {
		int highGrade = grades[0]; // assume grades[0] is the largest
	...
	public void outputBarChart() {
		...
		// for each grade, increment the appropriate grequency
		for (int grade : grades) {
			++frequency[grade / 10];
		}
