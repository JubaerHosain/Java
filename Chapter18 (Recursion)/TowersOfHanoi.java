...
public class TowersOfHanoi {
	...
	public static void solveTowers(int disks, int sourcePeg, int destinationPeg, int tempPeg) {
		System.out.println("here: " + disks + sourcePeg + destinationPeg + tempPeg);
		// base case -- only one disk to move
		if(disks == 1) {
			//System.out.print("A)" + disks + sourcePeg + destinationPeg + tempPeg);
		...
		System.out.printf("%n%d --> %d%n", sourcePeg, destinationPeg);
