...
public class PayrollSystemDemo {
	...
	public static void main(String[] args) {
		...
		SalariedEmployee salariedEmployee = new SalariedEmployee("Derek", "Tong", "111-11-1111", 800);
		HourlyEmployee hourlyEmployee = new HourlyEmployee("Sam", "Young", "222-22-2222", 16.75, 40);
		ComissionEmployee commissionEmployee = new ComissionEmployee("Jack", "Lee", "333-33-3333", 10000, .06);
		...
		for(Employee currentEmployee : employees) {
			...
			if(currentEmployee instanceof BasePlusCommissionEmployee) {
				...
				employee.setBaseSalary(1.20 * employee.getBaseSalary());
				
				System.out.printf("new base salary with 20%% increase is: $%,.2f%n", employee.getBaseSalary());
			}
